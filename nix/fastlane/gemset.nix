{
  ...
  faraday = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0kddc595wl2vqcib8wfqilb5w16mw0f68ghv4ji7ca1idcm81x3z";
      type = "gem";
    };
    version = "1.10.6";
  };
  ...
  xcodeproj = {
    dependencies = [ "CFPropertyList" "atomos" "base64" "claide" "colored2" "nanaimo" "nkf" "rexml" ];
    groups = [ "default" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
